...
async function initUI(localStorage) {
    ...
    // (will be fixed with TB91 -> https://bugzilla.mozilla.org/show_bug.cgi?id=1678057)
    ...
    document.getElementById("helpImageMozillaDino").setAttribute("src", "data:image/png;base64," + IMG_MOZILLA_DINO);
    ...
    document.getElementById("helpImageGithubOctocat").setAttribute("src", "data:image/png;base64," + IMG_GITHUB_OCTOCAT);
